...
Given('An existing birthday for {string} on {string}', async function (name, dob) {
...
When('I edit the birthday for {string} to be {string}', async function (name, dob) {
...
Then('the birthday for {string} should show {string}', async function (name, dob) {
	const birthdayListPage = new BirthdayListPage(this.page);
	await expect(birthdayListPage.entryFor(name)).toContainText(dob);
});
